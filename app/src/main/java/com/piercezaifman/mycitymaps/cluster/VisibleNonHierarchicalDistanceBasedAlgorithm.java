...
/**
 * Hacky class to speed up marker rendering, from here https://github.com/googlemaps/android-maps-utils/issues/29#issuecomment-176674872
 */
public class VisibleNonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : getClusteringItems(mQuadTree, discreteZoom)) {
                ...
                if (VisibleClusterManager.getBounds() != null && !VisibleClusterManager.getBounds().contains(candidate.mPosition)) {
